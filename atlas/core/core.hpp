...
namespace atlas {
    ...
    */
    ...
    /**
     * @brief construct strong_ptr<T> through atlas::memory::create_strong_ptr<T>(...);
     * 
     ...
     * @param ...Args is an argument pack for packing to deduce the types that is specified by object of type T
    */
