...
namespace atlas::event {
     ...
     * 
     * Listener that can have a different representation of a specific type of UEvent that gets specified to this listener
    */
    ...
    public:
        ...
        void subscribe(UObject* p_instance, const UCallback& p_callback) {
            m_event_handlers.push_back([p_instance, p_callback](UEvent& p_event) {
