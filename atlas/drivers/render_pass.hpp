...
namespace atlas {
    ...
    */
    ...
    //! @note Usage: Format that is defaulted to throughout the vulkan
    //! abstraction
    ...
    */
    ...
    /**
        ...
        @note Graphics Pipeline needs to know this on creation in order to
       compile frag shader properly
        @note In vulkan VkRenderPass is needed to be specified in
    ...
    */
    ...
    private:
        //! @note Implementation-detail on when renderpasses begin/end that is
        //! graphic-api agnostic
