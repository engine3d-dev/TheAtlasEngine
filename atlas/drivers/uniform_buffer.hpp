...
namespace atlas {
    ...
    /**
     * @name Uniform Buffer
     * @note Each uniform buffer will require you to specify requiremenst on the
     * descriptor set usage
     * @note Per uniform buffer you must specify descriptor uses of those
     * uniforms
     * @note Descriptor sets are how we group and these uniform data to the
     * shader that then gets offloaded to the GPU
     */
