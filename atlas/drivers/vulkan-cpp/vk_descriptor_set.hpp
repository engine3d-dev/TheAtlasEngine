...
namespace atlas::vk {
    ...
    public:
         ...
         * Tells vulkan when binding this descriptor set where the resources
         * location for shader to know where to access the resources binded
         *
         */
         ...
         * The vk_renderer will actually store in and cache vk::mesh into a
         * map<string, vk::mesh> Each mesh will actually store the actual
         * geometry data and apply a per-pipeline-info on them This update_mesh
         * would be invoked like(m_uniformss, m_cached_meshes[p_entity.name()]);
         * Where we invoke the mesh we want to update with the following
         * invokation call here vk::mesh will also contain the matrices such as
         * glm::mat4 that is the model matrix
         */
