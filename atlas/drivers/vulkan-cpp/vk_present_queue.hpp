...
namespace atlas::vk {
     ...
     * @brief This queue is for submitting presentation images through this
     * queue that gets displayed onto the swapchain
     * @brief Used by the vk_swapchain to present currently processed command
     * buffers to the swapchain
     */
    ...
    public:
         ...
         * @param p_swapchain presentation queue needs a swapchain of where the
         * images are being rendered to
         * @param p_queue_options specifies options on the types of queue family
         * index, and queue associated index to which queue family handler for
         * submitting work to
         */
        ...
        //! @return uint32_t next index to the presentable image for the current
        //! frame
