...
namespace atlas::vk {
    ...
    */
     ...
     *
     * Specifying requirements needed for specifying the vulkan renderpass
     * handlers
     */
    ...
    //! @brief Specifications of the vulkan buffer handlers and the use and
    //! memory bits associated with the buffer handlers
