...
export namespace atlas::vulkan {
    ...
    //     [[nodiscard]] window_params settings() const { return m_window_params; }
    ...
    //             m_swapchain_framebuffers[i].destruct();
    //         }

    //         m_final_renderpass.destruct();

    //         m_present_to_queue.destruct();

    //         for (size_t i = 0; i < m_swapchain_command_buffers.size(); i++) {
    //             m_swapchain_command_buffers[i].destruct();
    //         }

    //         for (uint32_t i = 0; i < m_swapchain_depth_images.size(); i++) {
    //             m_swapchain_depth_images[i].destruct();
    //         }

    //         for (uint32_t i = 0; i < m_swapchain_images.size(); i++) {
    //             m_swapchain_images[i].destruct();
    //         }
    ...
    //             .imageColorSpace =
    //               m_surface_properties.surface_format.colorSpace,
    ...
    //             // };
    //             vk::image_params color_image_params = {
    //                 .extent = {
    ...
    //               ::vk::sample_image(m_driver, images[i], color_image_params);

    //             vk::image_params depth_image_params = {
    //                 .extent = {
    //                     .width = m_swapchain_extent.width,
    //                     .height = m_swapchain_extent.height,
    //                 },
    ...
    //               ::vk::sample_image(m_driver, depth_image_params);
    //         }
    ...
    //               ::vk::command_buffer(m_driver, command_params);
    //         }
    ...
    //         };
    //         m_final_renderpass =
    //           ::vk::renderpass(m_driver, renderpass_attachments);
    ...
    //         console_log_info("m_presesnt_to_queue.alive() = {}",
    //                          (m_present_to_queue != nullptr));
    //     }

    //     uint32_t select_images_size(
    //       const VkSurfaceCapabilitiesKHR& p_surface_capabilities) {
    //         uint32_t requested_images =
    //           p_surface_capabilities.minImageCount + 1;
