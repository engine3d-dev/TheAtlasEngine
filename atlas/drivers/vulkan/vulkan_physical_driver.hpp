...
namespace atlas::vk {
     ...
     * @note physical devices in vulkan are a concept to interact with the
     * actual hardware on your system
     * @note enables you to directly submit tasks to the GPU using physical
     * devices is a concept defined by vulkan
     */
