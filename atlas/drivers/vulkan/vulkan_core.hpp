...
namespace atlas::vk{
    ...
    */
    ...
    void Submit(VkQueue p_queue_to_use, const UCallableTask& p_callable){
        ...
        vkQueueSubmit(p_queue_to_use, static_cast<uint32_t>(commands.size()), &submit_info, VK_NULL_HANDLE);
    ...
    void pipeline_image_barrier(VkCommandBuffer p_command_buffer, VkImage Image, VkAccessFlags srcAccessmask, VkAccessFlags dstAccessMask, VkImageLayout OldImageLayout, VkImageLayout NewImageLayout, VkPipelineStageFlags srcStageFlags, VkPipelineStageFlags dstStageFlags, VkImageSubresourceRange subresourceRange);
};