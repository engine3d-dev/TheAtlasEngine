...
namespace atlas::vulkan {
    ...
    public:
        ...
        imgui_context(const VkInstance& p_instance,
            ...
            console_log_info("imgui_context");
        ...
        void invalidate(const swapchain& p_swapchain) {
            ...
            m_depth_viewport_image.destruct();
            ...
            vk::image_params config_image = {
                ...
                .format = VK_FORMAT_B8G8R8A8_UNORM,
                .memory_mask = m_physical.memory_properties(vk::memory_property::device_local_bit),
                // .property = m_physical.memory_properties(vk::memory_property::device_local_bit),
                .aspect = vk::image_aspect_flags::color_bit,
                .usage = vk::image_usage::color_attachment_bit |
                         vk::image_usage::transfer_dst_bit |
                         vk::image_usage::sampled_bit,
        ...
        void destroy() {
            ...
            m_viewport_renderpass.destruct();
            m_viewport_image.destruct();
            m_depth_viewport_image.destruct();
    ...
    private:
        ...
        physical_device m_physical = nullptr;
        device m_driver{};
