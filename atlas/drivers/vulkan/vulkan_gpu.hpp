...
namespace atlas::vk {
    /**
     * @note These operations provide a way to directly execute commands to the
    GPU.
    ...
    internally vk::SubmitResourceFree([]{
        // This directly gets submitted to a queue for handling cleanup for the
    specific operation
        // Use case is if we wanted to cleanup imgui when at deconstruction for
    when the application ends, they get called here, and then added to queue for
    cleanup
    });
    */
