...
namespace engine3d{
    ...
    /*
    void EditorCamera::SetView(glm::vec3 Position, glm::vec3 Target, glm::vec3 Up){
    }

    void EditorCamera::SetViewXYZ(glm::vec3 Position, glm::vec3 Rotation){
    ...
    void EditorCamera::SetViewTarget(glm::vec3 Position, glm::vec3 Target, glm::vec3 Up){
        SetView(Position, Target - Position, Up);
    }
    */
   ...
   void EditorCamera::SetViewDirection(glm::vec3 Position, glm::vec3 Direction, glm::vec3 Up){
    ...
    void EditorCamera::SetOrthoProjection(float left, float right, float top, float bottom, float near, float far){
    ...
    void EditorCamera::SetPerspectiveProjection(float fovy, float aspect, float near, float far){
