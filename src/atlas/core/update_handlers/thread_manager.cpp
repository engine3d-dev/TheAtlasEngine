...
namespace atlas{
    ...
    thread_manager::thread_manager() : m_sync_update_thread("Sync Update Thread"){
    // thread_manager::thread_manager(){
        m_thread_stop = false;
        m_sync_update_thread.dispatch(&thread_manager::update_sync_function, this);
        ...
        // console_log_trace("Amount of Threads Specified: {}", core_amount_half);
    ...
    void thread_manager::update_parallel_function(){
        ...
        /*
            ...
            1.2 Then sync with global update using g_Parallel.wait (g_parallel_frame)
