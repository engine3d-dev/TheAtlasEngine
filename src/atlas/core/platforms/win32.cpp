...
extern atlas::ref<atlas::application_instance> atlas::initialize_application();
...
int Main(){
    ...
    // atlas::global_updateManager* s_global_updateManager = atlas::global_update::GetInstance();
    atlas::ref<atlas::application_instance> app = atlas::initialize_application();
