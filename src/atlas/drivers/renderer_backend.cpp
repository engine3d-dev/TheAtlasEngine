...
namespace atlas{
    ...
    // void render_context::set_custom_shader(const std::string& p_Vert, const std::string& p_Frag, bool p_IsOverride){
    ...
    void render_context::render_with_camera(ref<scene_object>& p_scene_object, ref<scene_object>& p_camera){
