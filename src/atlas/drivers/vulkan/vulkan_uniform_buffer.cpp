...
namespace atlas::vk {
    // VulkanUniformBuffer::VulkanUniformBuffer(uint32_t p_Size, uint32_t
    // p_InstanceCount){
    ...
    // void VulkanUniformBuffer::MapWrite(uint32_t p_DeviceSize, uint32_t
    // p_Offset, const void* p_Src){
    // }
};