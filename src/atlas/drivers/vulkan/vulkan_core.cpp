...
namespace atlas::vk {
    VkCommandBuffer create_command_buffer_and_record(
      ...
      const VkCommandPool& p_command_buffer) {
        ...
        vk_check(vkAllocateCommandBuffers(
                   p_driver, &cmd_buffer_alloc_info, &command_buffer),
        ...
        vk_check(vkBeginCommandBuffer(command_buffer, &cmd_buffer_begin_info),
    ...
    void begin_command_buffer(const VkCommandBuffer& p_command_buffer) {
        ...
        vk_check(vkBeginCommandBuffer(p_command_buffer, &cmd_buffer_begin_info),
                 "vkBeginCommandBuffer",
                 __FILE__,
                 __LINE__,
                 __FUNCTION__);
    ...
    void submit(VkQueue p_queue_to_use,
        ...
        VkSubmitInfo submit_info = {
            ...
            .commandBufferCount =
              static_cast<uint32_t>(p_command_buffers.size()),
    ...
    VkImageView create_image_view(VkImage p_image, VkFormat p_surface_format) {
        ...
        vk_check(vkCreateImageView(vk_context::get_current_driver(),
    ...
    VkImage create_image(VkFormat p_format,
        ...
        vk_check(
          vkCreateImage(
            vk_context::get_current_driver(), &image_ci, nullptr, &new_image),
          "vkCreateImage",
          __FILE__,
          __LINE__,
          __FUNCTION__);
    ...
    VkCommandBuffer begin_single_time_command_buffer(
      const VkCommandPool& p_command_pool) {
        ...
        vk_check(vkAllocateCommandBuffers(vk_context::get_current_driver(),
                                          &alloc_info,
                                          &temp_command_buffer),
                 "vkAllocateCommandBuffers",
                 __FILE__,
    ...
    void end_single_time_command_buffer(const VkCommandBuffer& p_command_buffer,
        ...
        vkFreeCommandBuffers(vk_context::get_current_driver(),
                             p_command_pool,
                             1,
                             &p_command_buffer);
    }
    ...
    VkCommandPool create_command_pool() {
        ...
        vk_check(vkCreateCommandPool(vk_context::get_current_driver(),
                                     &cmd_pool_ci,
                                     nullptr,
                                     &temp_command_pool),
                 "vkCreateCommandPool",
    ...
    void pipeline_image_barrier(VkCommandBuffer p_command_buffer,
                                VkImage p_image,
                                VkAccessFlags p_src_access_mask,
                                VkAccessFlags p_dst_access_mask,
                                VkImageLayout p_old_image_layout,
                                VkImageLayout p_new_image_layout,
                                VkPipelineStageFlags p_src_stage_flags,
                                VkPipelineStageFlags p_dst_stage_flags,
                                VkImageSubresourceRange p_subresource_range) {
