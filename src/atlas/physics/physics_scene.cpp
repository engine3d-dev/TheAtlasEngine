...
namespace atlas::physics {
    ...
    void physics_scene::on_runtime_start() {
        ...
        physics::ObjectVsBPLayerFilterInterface
        ...
        // JPH::RVec3 inPosition =
        // JPH::RVec3(physics::to_rvec3(sphere_position));
        ...
        JPH::BodyCreationSettings floor_settings(
          floor_shape, inPosition, inRotation, inMotionType, bodyType);
    ...
    void add_scene_object(
      [[maybe_unused]] const ref<scene_object>& p_current_object) {}
    ...
    void physics_scene::on_runtime_update([[maybe_unused]] float physics_dt) {
        ...
        //! @note We are going to query all of the entities within our scene and
        //! check if they all have a RigidBody3D component associated with them
        //! @note In flecs we query what component we want to check for all our
        //! entities that are stored in flecs::world
        auto all_entities = world->query<RigidBody3D>();

        // We are going through all those entities with this specific component
        // and we want to start the physics simulation if those entities have
