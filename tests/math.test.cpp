...
namespace atlas {
     ...
     * @note What this does is customizing to utilize a different mathematical
     * data type
     * @note We are not defining our own vector and the operations of how that
     * is done
     * @note We simply specialized the type we expect, then do all of that
     * operation with that specified type
     *       - then we simply return to the default glm type once we are done
