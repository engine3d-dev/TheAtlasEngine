 ...
 * @note Since there are various ways of managing scenes, this part wont be written at the moment
 * @note Test: if the scene we create is allow to pass in scene contexts correctly
 * @note Test: User-defined customizable scenes which can help to test parts of creating scenes if users want to
