		...
		public:
			...
			template<typename T, typename... Args>
				void AddComponent(Args&&... args)
				{
					...
					T& component = m_ParentScene->m_SceneRegistry.emplace<T>(SceneObjectHandler, std::forward<Args>(args)...);

					// Adding refrence to component
					component -> SetSceneObjectRef(this);
					
					//! @note Call to component to do specific action when integrating with gameObject
			...
			bool operator==(const SceneObject& other) const { return SceneObjectHandler == other.SceneObjectHandler and m_ParentScene == other.m_ParentScene; }
