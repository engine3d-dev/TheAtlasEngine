...
namespace engine3d 
{
    /**
     * @note Revised
     * @note Removing the templated functions because they require this component to take up more space with these templated functions.
    */
    class Transform
    {
    public:
        ...
        T GetQuat()
        {
            T quat(m_QuaterionRot.x,m_QuaterionRot.y,m_QuaterionRot.z,m_QuaterionRot.w);
            return quat;
        }
        ...
        glm::highp_vec3 m_Position{0.0f};
        glm::highp_vec4 m_QuaterionRot{0.0f};
        glm::highp_vec3 m_AxisRotation{0.0f};
        glm::highp_vec3 Scale{0.0f};

        //! @note SceneNode will handle our parent.
