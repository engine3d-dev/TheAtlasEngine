...
public:
    test_application(atlas::ref<atlas::graphics_context> p_context, const atlas::application_settings& p_settings) : atlas::application(p_context, p_settings) {
...
atlas::ref<atlas::application> initialize_application(atlas::ref<atlas::graphics_context> p_contetxt) {
